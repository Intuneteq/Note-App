...
export default function MyNote ({title, description, _id}) {
  ...
  return (
    ...
    {isDeleting ? <Oval color="#00BFFF" height={80} width={80} /> : ""}
      <h1 className='text-center mb-5 uppercase font-black md:text-xl lg:text-3xl xl:text-4xl'>{ title }</h1>
      <p className='font-medium text-justify mb-8'>{ description }</p>
